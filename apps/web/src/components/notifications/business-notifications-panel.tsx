...
import { Bell, Calendar, Clock, X, Trash2, Mail } from 'lucide-react';
...
export function BusinessNotificationsPanel({
  ...
  unreadCount,
}: BusinessNotificationsPanelProps) {
        ...
        <div className="max-h-80 overflow-y-auto">
          {notifications.length === 0 ? (
            <div className="p-8 text-center text-gray-500">
              ...
              <p className="text-sm">
                Customer booking requests and updates will appear here.
              </p>
            </div>
          ) : (
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          ...
                          {notification.requestedDate &&
                            notification.requestedTime && (
                              <p className="text-xs text-gray-500 mt-1">
                                {new Date(
                                  notification.requestedDate
                                ).toLocaleDateString()}{' '}
                                at {notification.requestedTime}
                              </p>
                            )}
                        </div>
